                        ...
                        <table class="table table-striped" cellspacing="0" cellpadding="0">
                            <thead>
                                <tr>
                                    ...
                                    <th class="actions1">Comparecerá?</th>
                                    <th class="actions2">Ações</th>
                                </tr>
                            </thead>
                            <tbody>
          					<c:forEach var="convidados" items="${lista}">
                                       <tr>
                                            ...
                                            <td class="actions1">
                                                ...
                                                <button id="btn${convidados.id}%>" type="button" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#delete-modal" data-convidados="${convidados.id}">Não</button>
