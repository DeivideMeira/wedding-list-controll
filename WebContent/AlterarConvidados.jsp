...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
        ...
        <head>
            ...
            <title>NSA - Alterar Convidados</title>
        ...
        <body id="body">
                ...
                <div id="main" class="container">
                    <h3 class="page-header" ">Alterar Convidado ${convidados.nome }</h3>
                    ...
                    <form action="controller.do" method="post">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" name="cpf" id="cpf" maxlength="11" placeholder="Digite o CPF do convidado" value="${convidados.cpf }">
                            </div>
                            </div>
                        ...
                        <div id="actions" class="row">
                            <div class="col-md-12">
                                <button type="submit" class="btn btn-primary" name="command" value="AlterarConvidados">Salvar</button>
                                <a href="ListarConvidados.jsp" class="btn btn-default">Cancelar</a>
                            </div>
                        </div>
                    </form>
                </div>
